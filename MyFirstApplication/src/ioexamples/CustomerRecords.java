...
public class CustomerRecords {
	...
	public void saveToFile(Customer obj){
		try{
			FileOutputStream fout =new FileOutputStream("C://ioexamples//objfile.txt");
			ObjectOutputStream objout = new ObjectOutputStrem(fout);
	...
	public void readFromFile(){
		try{
			FileInputStream fin = new FileInputStream("C://ioexamples//objfile.txt");
